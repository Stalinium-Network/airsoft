    ...
    <div className="bg-gray-800 rounded-lg p-6 shadow-lg mb-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="bg-gray-700 p-1 rounded-lg inline-flex">
          <button 
            className={`px-4 py-1 rounded-md transition-all ${filter === 'upcoming' ? 'bg-green-600 text-white' : 'text-gray-300'}`}
            onClick={() => onFilterChange('upcoming')}
          >
            Upcoming
          </button>
          <button 
            className={`px-4 py-1 rounded-md transition-all ${filter === 'past' ? 'bg-green-600 text-white' : 'text-gray-300'}`}
          ...
          >
            ...
            <div className="p-4">
              ...
              <div className="text-xs text-gray-400 mb-3">
                ...
                <div>Capacity: {game.capacity.filled}/{game.capacity.total}</div>
              </div>
