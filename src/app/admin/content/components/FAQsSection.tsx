      ...
      <div className="space-y-4">
        {isLoading && faqs.length === 0 ? (
          ...
          faqs.map((faq) => (
            <div 
              key={faq._id} 
              className="bg-gradient-to-b from-gray-800 to-gray-900 border border-gray-700 rounded-lg overflow-hidden shadow-lg hover:shadow-green-900/30 hover:border-gray-600 transition-all transform hover:scale-[1.02]"
            >
              <div className="p-5">
                ...
                <div className="flex space-x-2 mt-4 border-t border-gray-700 pt-4">
                  <button
                    ...
                    className="flex-1 bg-blue-600 hover:bg-blue-700 text-white py-2 px-3 rounded-md text-sm transition-all transform hover:scale-[1.02]"
                  >
                    Edit
                  </button>
                  <button
                    ...
                    disabled={isLoading}
                    className="flex items-center justify-center bg-red-600 hover:bg-red-700 text-white py-2 px-3 rounded-md text-sm transition-all transform hover:scale-[1.02]"
                  >
